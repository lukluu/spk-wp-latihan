                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-12 text-center mt-3">
                                <h1 class="h1 text-gray-900">Sistem Penunjang Keputusan</h1>
                                <h2 class="h5 text-gray-900">Weighted Product</h2>
                            </div>
                                    ...
                                    <form class="user" method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control form-control-user" name="name" id="name" value="{{ old('name') }}" required autofocus placeholder="Enter Full Name...">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="input-group">
